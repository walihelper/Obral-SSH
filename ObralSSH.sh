...
# setting repo
wget https://www.dropbox.com/s/q3ggrha51pb0r1p/epel-release-6-8.noarch.rpm
wget https://www.dropbox.com/s/9q2t641oded42jp/remi-release-6.rpm
rpm -Uvh epel-release-6-8.noarch.rpm
rpm -Uvh remi-release-6.rpm

if [ "$OS" == "x86_64" ]; then
  wget https://www.dropbox.com/s/eb32bkz5j2fw37f/rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm
  rpm -Uvh rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm
else
  wget https://www.dropbox.com/s/w9aqmbiulmz1mko/rpmforge-release-0.5.3-1.el6.rf.i686.rpm
...
# install openvpn
cd /etc/openvpn/
wget --no-check-certificate -O ~/easy-rsa.tar.gz https://www.dropbox.com/s/9n6pnlpqmskp5kc/2.2.2.tar.gz
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://www.dropbox.com/s/3fd1jds31aacnoc/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://www.dropbox.com/s/bx28orc2a08n8ko/badvpn-udpgw64"
fi
...
wget https://www.dropbox.com/s/8dya1ow66ise90w/vnstat_php_frontend-1.5.1.tar.gz
...
# install bmon
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/bmon "https://www.dropbox.com/s/9xi8ya3ta5operj/bmon64"
else
  wget -O /usr/bin/bmon "https://www.dropbox.com/s/ld8iosai9xv2uhn/bmon"
fi
...
echo ""  | tee -a log-install.txt
echo "Welcome To AutoScript SSH Installer"  | tee -a log-install.txt
echo "Create By obhy.eu" | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "Log Instalasi --> /root/log-install.txt"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "INSTALLASI SELESAI, VPS AUTO REBOOT TIAP 6 JAM, SILAHKAN REBOOT VPS ANDA !"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "==========================================="  | tee -a log-install.txt
